...
st.caption(f"##### 주행이나 주차시 발생할 수 있는 문제들에 대해 자신의 윤리적 가치관을 설정해 보세요 !")
...
st.markdown("### 아래 코드를 아두이노 IDE에 그대로 복붙하면 됩니다!")
...
3. 지금 선택한 윤리 이슈(예: *보행자 우선*, *운전자 우선* 등)에 맞는 행동만 실행됩니다! 🚗  
""")
